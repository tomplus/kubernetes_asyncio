...
class V1PodDisruptionBudget:
    ...
    def __init__(self, *, api_version: typing.Optional[str] = ..., kind: typing.Optional[str] = ..., metadata: typing.Optional[kubernetes_asyncio.client.V1ObjectMeta] = ..., spec: typing.Optional[kubernetes_asyncio.client.V1PodDisruptionBudgetSpec] = ..., status: typing.Optional[kubernetes_asyncio.client.V1PodDisruptionBudgetStatus] = ...) -> None:
        ...
