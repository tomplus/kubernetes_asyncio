...
class V1beta1CronJobSpec:
    ...
    job_template: kubernetes_asyncio.client.V1beta1JobTemplateSpec
    schedule: str
    ...
    def __init__(self, *, concurrency_policy: typing.Optional[str] = ..., failed_jobs_history_limit: typing.Optional[int] = ..., job_template: kubernetes_asyncio.client.V1beta1JobTemplateSpec, schedule: str, starting_deadline_seconds: typing.Optional[int] = ..., successful_jobs_history_limit: typing.Optional[int] = ..., suspend: typing.Optional[bool] = ..., time_zone: typing.Optional[str] = ...) -> None:
        ...
...
class V1beta1CronJobSpecDict(typing.TypedDict, total=False):
    ...
    jobTemplate: kubernetes_asyncio.client.V1beta1JobTemplateSpecDict
    schedule: str
