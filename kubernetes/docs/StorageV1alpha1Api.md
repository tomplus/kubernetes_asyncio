...
api_instance = kubernetes.client.StorageV1alpha1Api(kubernetes.client.ApiClient(configuration))
body = kubernetes.client.V1alpha1VolumeAttachment() # V1alpha1VolumeAttachment | 
