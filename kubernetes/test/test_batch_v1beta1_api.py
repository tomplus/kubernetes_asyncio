...
from kubernetes.client.api.batch_v1beta1_api import BatchV1beta1Api  # noqa: E501
...
class TestBatchV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes.client.api.batch_v1beta1_api.BatchV1beta1Api()  # noqa: E501
