...
class V1beta1PodDisruptionBudgetStatus(object):
    ...
    def __init__(self, current_healthy=None, desired_healthy=None, disrupted_pods=None, disruptions_allowed=None, expected_pods=None, observed_generation=None):  # noqa: E501
        """V1beta1PodDisruptionBudgetStatus - a model defined in Swagger"""  # noqa: E501
    ...
    def disrupted_pods(self, disrupted_pods):
        ...
        if disrupted_pods is None:
            raise ValueError("Invalid value for `disrupted_pods`, must not be `None`")  # noqa: E501
    ...
    def observed_generation(self):
        ...
        Most recent generation observed when updating this PDB status. PodDisruptionsAllowed and other status informatio is valid only if observedGeneration equals to PDB's object generation.  # noqa: E501
