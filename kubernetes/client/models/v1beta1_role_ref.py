...
class V1beta1RoleRef(object):
    ...
    def __init__(self, api_group=None, kind=None, name=None):  # noqa: E501
        """V1beta1RoleRef - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def api_group(self):
        """Gets the api_group of this V1beta1RoleRef.  # noqa: E501

        APIGroup is the group for the resource being referenced  # noqa: E501

        :return: The api_group of this V1beta1RoleRef.  # noqa: E501
        :rtype: str
        """
    ...
    def api_group(self, api_group):
        ...
        :param api_group: The api_group of this V1beta1RoleRef.  # noqa: E501
        :type: str
        """
    ...
    @property
    def kind(self):
        """Gets the kind of this V1beta1RoleRef.  # noqa: E501

        Kind is the type of resource being referenced  # noqa: E501

        :return: The kind of this V1beta1RoleRef.  # noqa: E501
        :rtype: str
        """
        return self._kind
    ...
    def kind(self, kind):
        ...
        :param kind: The kind of this V1beta1RoleRef.  # noqa: E501
        :type: str
        """
        if kind is None:
    ...
    @property
    def name(self):
        """Gets the name of this V1beta1RoleRef.  # noqa: E501

        Name is the name of resource being referenced  # noqa: E501

        :return: The name of this V1beta1RoleRef.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this V1beta1RoleRef.  # noqa: E501
        :type: str
        """
        if name is None:
