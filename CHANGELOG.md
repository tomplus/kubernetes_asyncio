...
* chore: Fix ruff formatting and checks ([#397](https://github.com/tomplus/kubernetes_asyncio/pull/397), [@tomplus](https://github.com/tomplus))
* chore: Move project configuration to pyproject.toml ([#396](https://github.com/tomplus/kubernetes_asyncio/pull/396), [@tomplus](https://github.com/tomplus))
* chore: Fix typing in log tail example ([#395](https://github.com/tomplus/kubernetes_asyncio/pull/395), [@tomplus](https://github.com/tomplus))
...
* feat: add type annotations ([#382](https://github.com/tomplus/kubernetes_asyncio/pull/382), [@tomplus](https://github.com/tomplus))

### Changes

* fix loading items from the List objects ([#380](https://github.com/tomplus/kubernetes_asyncio/pull/380), [@SheGe](https://github.com/SheGe))
* feat(config): support cluster proxy-url from kubeconfig ([#378](https://github.com/tomplus/kubernetes_asyncio/pull/378), [@DarshanCode2005](https://github.com/DarshanCode2005))
* Update supported Python versions ([#375](https://github.com/tomplus/kubernetes_asyncio/pull/375), [@jaseemabid](https://github.com/jaseemabid))
* chore: simplify generation process by using patched files ([#383](https://github.com/tomplus/kubernetes_asyncio/pull/383), [@tomplus](https://github.com/tomplus))
