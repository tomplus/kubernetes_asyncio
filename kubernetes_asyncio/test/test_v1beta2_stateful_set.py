...
from kubernetes_asyncio.client.models.v1beta2_stateful_set import V1beta2StatefulSet  # noqa: E501
...
class TestV1beta2StatefulSet(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1beta2_stateful_set.V1beta2StatefulSet()  # noqa: E501
        if include_optional :
            return V1beta2StatefulSet(
                ...
                metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                    ...
                    self_link = '0', 
                    uid = '0', ), 
                spec = kubernetes_asyncio.client.models.v1beta2/stateful_set_spec.v1beta2.StatefulSetSpec(
                    ...
                    update_strategy = kubernetes_asyncio.client.models.v1beta2/stateful_set_update_strategy.v1beta2.StatefulSetUpdateStrategy(
                        rolling_update = kubernetes_asyncio.client.models.v1beta2/rolling_update_stateful_set_strategy.v1beta2.RollingUpdateStatefulSetStrategy(
                            partition = 56, ), 
                        type = '0', ), 
                ...
                status = kubernetes_asyncio.client.models.v1beta2/stateful_set_status.v1beta2.StatefulSetStatus(
                    collision_count = 56, 
                    conditions = [
                        kubernetes_asyncio.client.models.v1beta2/stateful_set_condition.v1beta2.StatefulSetCondition(
                            last_transition_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            message = '0', 
                            reason = '0', 
                            status = '0', 
