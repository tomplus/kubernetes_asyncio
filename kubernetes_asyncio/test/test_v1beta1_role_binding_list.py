...
from kubernetes_asyncio.client.models.v1beta1_role_binding_list import V1beta1RoleBindingList  # noqa: E501
...
class TestV1beta1RoleBindingList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1beta1_role_binding_list.V1beta1RoleBindingList()  # noqa: E501
        if include_optional :
            return V1beta1RoleBindingList(
                api_version = '0', 
                items = [
                    kubernetes_asyncio.client.models.v1beta1/role_binding.v1beta1.RoleBinding(
                        api_version = '0', 
                        kind = '0', 
