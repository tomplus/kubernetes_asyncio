...
from kubernetes_asyncio.client.models.v1beta1_controller_revision_list import V1beta1ControllerRevisionList  # noqa: E501
...
class TestV1beta1ControllerRevisionList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1beta1_controller_revision_list.V1beta1ControllerRevisionList()  # noqa: E501
        if include_optional :
            return V1beta1ControllerRevisionList(
                api_version = '0', 
                items = [
                    kubernetes_asyncio.client.models.v1beta1/controller_revision.v1beta1.ControllerRevision(
                        api_version = '0', 
