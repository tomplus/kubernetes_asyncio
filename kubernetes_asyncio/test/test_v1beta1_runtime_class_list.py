...
from kubernetes_asyncio.client.models.v1beta1_runtime_class_list import V1beta1RuntimeClassList  # noqa: E501
...
class TestV1beta1RuntimeClassList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1beta1_runtime_class_list.V1beta1RuntimeClassList()  # noqa: E501
        if include_optional :
            return V1beta1RuntimeClassList(
                api_version = '0', 
                items = [
                    kubernetes_asyncio.client.models.v1beta1/runtime_class.v1beta1.RuntimeClass(
                        api_version = '0', 
                        handler = '0', 
                        kind = '0', 
