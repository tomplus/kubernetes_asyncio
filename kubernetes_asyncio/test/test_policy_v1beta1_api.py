...
from kubernetes_asyncio.client.api.policy_v1beta1_api import PolicyV1beta1Api  # noqa: E501
...
class TestPolicyV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes_asyncio.client.api.policy_v1beta1_api.PolicyV1beta1Api()  # noqa: E501
