...
from kubernetes_asyncio.client.models.v1alpha1_role_binding_list import V1alpha1RoleBindingList  # noqa: E501
...
class TestV1alpha1RoleBindingList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1alpha1_role_binding_list.V1alpha1RoleBindingList()  # noqa: E501
        if include_optional :
            return V1alpha1RoleBindingList(
                api_version = '0', 
                items = [
                    kubernetes_asyncio.client.models.v1alpha1/role_binding.v1alpha1.RoleBinding(
                        api_version = '0', 
                        kind = '0', 
