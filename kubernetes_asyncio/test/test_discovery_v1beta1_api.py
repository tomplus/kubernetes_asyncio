...
from kubernetes_asyncio.client.api.discovery_v1beta1_api import DiscoveryV1beta1Api  # noqa: E501
...
class TestDiscoveryV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes_asyncio.client.api.discovery_v1beta1_api.DiscoveryV1beta1Api()  # noqa: E501
