...
from kubernetes_asyncio.client.models.v1beta1_token_review import V1beta1TokenReview  # noqa: E501
...
class TestV1beta1TokenReview(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1beta1_token_review.V1beta1TokenReview()  # noqa: E501
        if include_optional :
            return V1beta1TokenReview(
                ...
                metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                    ...
                    self_link = '0', 
                    uid = '0', ), 
                spec = kubernetes_asyncio.client.models.v1beta1/token_review_spec.v1beta1.TokenReviewSpec(
                    audiences = [
                        '0'
                        ], 
                    token = '0', ), 
                status = kubernetes_asyncio.client.models.v1beta1/token_review_status.v1beta1.TokenReviewStatus(
                    audiences = [
                        '0'
                        ], 
                    authenticated = True, 
                    error = '0', 
                    user = kubernetes_asyncio.client.models.v1beta1/user_info.v1beta1.UserInfo(
                        extra = {
                            'key' : [
                                '0'
                                ]
