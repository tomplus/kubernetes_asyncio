...
from kubernetes_asyncio.client.api.core_v1_api import CoreV1Api  # noqa: E501
...
class TestCoreV1Api(unittest.IsolatedAsyncioTestCase):
    ...
    def test_delete_collection_namespaced_service(self):
    ...
    def test_patch_namespaced_pod_ephemeralcontainers(self):
        """Test case for patch_namespaced_pod_ephemeralcontainers

        """
        pass

    def test_patch_namespaced_pod_resize(self):
    ...
    def test_read_namespaced_pod_ephemeralcontainers(self):
    ...
    def test_read_namespaced_pod_resize(self):
    ...
    def test_replace_namespaced_pod_ephemeralcontainers(self):
        """Test case for replace_namespaced_pod_ephemeralcontainers

        """
        pass

    def test_replace_namespaced_pod_resize(self):
