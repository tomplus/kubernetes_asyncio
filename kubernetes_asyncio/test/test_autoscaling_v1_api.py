...
from kubernetes.client.api.autoscaling_v1_api import AutoscalingV1Api  # noqa: E501
...
class TestAutoscalingV1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes.client.api.autoscaling_v1_api.AutoscalingV1Api()  # noqa: E501
