...
from kubernetes_asyncio.client.models.v1_lease_spec import V1LeaseSpec  # noqa: E501
...
class TestV1LeaseSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1_lease_spec.V1LeaseSpec()  # noqa: E501
        if include_optional :
            return V1LeaseSpec(
