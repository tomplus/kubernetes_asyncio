...
from kubernetes_asyncio.client.models.v1beta1_priority_class_list import V1beta1PriorityClassList  # noqa: E501
...
class TestV1beta1PriorityClassList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1beta1_priority_class_list.V1beta1PriorityClassList()  # noqa: E501
        if include_optional :
            return V1beta1PriorityClassList(
                api_version = '0', 
                items = [
                    kubernetes_asyncio.client.models.v1beta1/priority_class.v1beta1.PriorityClass(
                        api_version = '0', 
                        description = '0', 
                        global_default = True, 
                        kind = '0', 
