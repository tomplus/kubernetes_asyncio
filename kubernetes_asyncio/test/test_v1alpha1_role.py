...
from kubernetes_asyncio.client.models.v1alpha1_role import V1alpha1Role  # noqa: E501
...
class TestV1alpha1Role(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1alpha1_role.V1alpha1Role()  # noqa: E501
        if include_optional :
            return V1alpha1Role(
                api_version = '0', 
                kind = '0', 
