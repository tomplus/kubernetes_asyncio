        ...
        if include_optional :
            return AppsV1beta1Scale(
                ...
                metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                    ...
                    self_link = '0', 
                    uid = '0', ), 
                spec = kubernetes_asyncio.client.models.apps/v1beta1/scale_spec.apps.v1beta1.ScaleSpec(
                    replicas = 56, ), 
                status = kubernetes_asyncio.client.models.apps/v1beta1/scale_status.apps.v1beta1.ScaleStatus(
                    replicas = 56, 
                    selector = {
                        'key' : '0'
                        }, 
