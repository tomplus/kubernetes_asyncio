...
from kubernetes_asyncio.client.models.v1beta1_validating_webhook_configuration_list import V1beta1ValidatingWebhookConfigurationList  # noqa: E501
...
class TestV1beta1ValidatingWebhookConfigurationList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1beta1_validating_webhook_configuration_list.V1beta1ValidatingWebhookConfigurationList()  # noqa: E501
        if include_optional :
            return V1beta1ValidatingWebhookConfigurationList(
                api_version = '0', 
                items = [
                    kubernetes_asyncio.client.models.v1beta1/validating_webhook_configuration.v1beta1.ValidatingWebhookConfiguration(
                        api_version = '0', 
                        kind = '0', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            uid = '0', ), 
                        webhooks = [
                            kubernetes_asyncio.client.models.v1beta1/validating_webhook.v1beta1.ValidatingWebhook(
                                admission_review_versions = [
                                    '0'
                                    ], 
                                kubernetes_asyncio.client_config = kubernetes_asyncio.client.models.admissionregistration/v1beta1/webhook_client_config.admissionregistration.v1beta1.WebhookClientConfig(
                                    ca_bundle = 'YQ==', 
                                    service = kubernetes_asyncio.client.models.admissionregistration/v1beta1/service_reference.admissionregistration.v1beta1.ServiceReference(
                                        name = '0', 
                                        namespace = '0', 
                                        path = '0', 
                                        port = 56, ), 
                                ...
                                rules = [
                                    kubernetes_asyncio.client.models.v1beta1/rule_with_operations.v1beta1.RuleWithOperations(
                                        api_groups = [
                                            '0'
                                            ], 
                                        api_versions = [
