...
from kubernetes_asyncio.client.models.v1_config_map import V1ConfigMap  # noqa: E501
...
class TestV1ConfigMap(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1_config_map.V1ConfigMap()  # noqa: E501
        if include_optional :
            return V1ConfigMap(
                api_version = '', 
                binary_data = {
