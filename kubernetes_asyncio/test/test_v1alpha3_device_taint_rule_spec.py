...
from kubernetes_asyncio.client.models.v1alpha3_device_taint_rule_spec import V1alpha3DeviceTaintRuleSpec  # noqa: E501
...
class TestV1alpha3DeviceTaintRuleSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1alpha3_device_taint_rule_spec.V1alpha3DeviceTaintRuleSpec()  # noqa: E501
        if include_optional :
