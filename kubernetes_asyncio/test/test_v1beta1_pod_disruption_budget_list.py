...
from kubernetes_asyncio.client.models.v1beta1_pod_disruption_budget_list import V1beta1PodDisruptionBudgetList  # noqa: E501
...
class TestV1beta1PodDisruptionBudgetList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1beta1_pod_disruption_budget_list.V1beta1PodDisruptionBudgetList()  # noqa: E501
        if include_optional :
            return V1beta1PodDisruptionBudgetList(
                api_version = '0', 
                items = [
                    kubernetes_asyncio.client.models.v1beta1/pod_disruption_budget.v1beta1.PodDisruptionBudget(
                        api_version = '0', 
                        kind = '0', 
