...
from kubernetes_asyncio.client.models.v2_external_metric_status import V2ExternalMetricStatus  # noqa: E501
...
class TestV2ExternalMetricStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v2_external_metric_status.V2ExternalMetricStatus()  # noqa: E501
        if include_optional :
