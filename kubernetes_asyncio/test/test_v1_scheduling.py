...
from kubernetes_asyncio.client.models.v1_scheduling import V1Scheduling  # noqa: E501
...
class TestV1Scheduling(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1_scheduling.V1Scheduling()  # noqa: E501
        if include_optional :
            return V1Scheduling(
                node_selector = {
                    'key' : ''
