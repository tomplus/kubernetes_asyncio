...
from kubernetes_asyncio.client.models.v1_endpoints import V1Endpoints  # noqa: E501
...
class TestV1Endpoints(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1_endpoints.V1Endpoints()  # noqa: E501
        if include_optional :
            return V1Endpoints(
                api_version = '', 
                kind = '', 
