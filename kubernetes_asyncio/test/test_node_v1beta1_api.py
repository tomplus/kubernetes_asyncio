...
from kubernetes_asyncio.client.api.node_v1beta1_api import NodeV1beta1Api  # noqa: E501
...
class TestNodeV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes_asyncio.client.api.node_v1beta1_api.NodeV1beta1Api()  # noqa: E501
