...
from kubernetes_asyncio.client.models.v1beta1_daemon_set_list import V1beta1DaemonSetList  # noqa: E501
...
class TestV1beta1DaemonSetList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1beta1_daemon_set_list.V1beta1DaemonSetList()  # noqa: E501
        if include_optional :
            return V1beta1DaemonSetList(
                api_version = '0', 
                items = [
                    kubernetes_asyncio.client.models.v1beta1/daemon_set.v1beta1.DaemonSet(
                        api_version = '0', 
                        kind = '0', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '0', 
                            uid = '0', ), 
                        spec = kubernetes_asyncio.client.models.v1beta1/daemon_set_spec.v1beta1.DaemonSetSpec(
                            ...
                            template_generation = 56, 
                            update_strategy = kubernetes_asyncio.client.models.v1beta1/daemon_set_update_strategy.v1beta1.DaemonSetUpdateStrategy(
                                rolling_update = kubernetes_asyncio.client.models.v1beta1/rolling_update_daemon_set.v1beta1.RollingUpdateDaemonSet(
                                    max_unavailable = kubernetes_asyncio.client.models.max_unavailable.maxUnavailable(), ), 
                                type = '0', ), ), 
                        status = kubernetes_asyncio.client.models.v1beta1/daemon_set_status.v1beta1.DaemonSetStatus(
                            collision_count = 56, 
                            conditions = [
