...
from kubernetes_asyncio.client.api.node_v1alpha1_api import NodeV1alpha1Api  # noqa: E501
...
class TestNodeV1alpha1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes_asyncio.client.api.node_v1alpha1_api.NodeV1alpha1Api()  # noqa: E501
