...
from kubernetes_asyncio.client.models.v1beta1_api_service_list import V1beta1APIServiceList  # noqa: E501
...
class TestV1beta1APIServiceList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1beta1_api_service_list.V1beta1APIServiceList()  # noqa: E501
        if include_optional :
            return V1beta1APIServiceList(
                api_version = '0', 
                items = [
                    kubernetes_asyncio.client.models.v1beta1/api_service.v1beta1.APIService(
                        api_version = '0', 
                        kind = '0', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '0', 
                            uid = '0', ), 
                        spec = kubernetes_asyncio.client.models.v1beta1/api_service_spec.v1beta1.APIServiceSpec(
                            ca_bundle = 'YQ==', 
                            group = '0', 
                            group_priority_minimum = 56, 
                            insecure_skip_tls_verify = True, 
                            service = kubernetes_asyncio.client.models.apiregistration/v1beta1/service_reference.apiregistration.v1beta1.ServiceReference(
                                name = '0', 
                                namespace = '0', 
                                port = 56, ), 
                            version = '0', 
                            version_priority = 56, ), 
                        status = kubernetes_asyncio.client.models.v1beta1/api_service_status.v1beta1.APIServiceStatus(
                            conditions = [
                                kubernetes_asyncio.client.models.v1beta1/api_service_condition.v1beta1.APIServiceCondition(
