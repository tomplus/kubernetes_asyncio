...
from kubernetes_asyncio.client.models.v1beta1_network_policy_list import V1beta1NetworkPolicyList  # noqa: E501
...
class TestV1beta1NetworkPolicyList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1beta1_network_policy_list.V1beta1NetworkPolicyList()  # noqa: E501
        if include_optional :
            return V1beta1NetworkPolicyList(
                api_version = '0', 
                items = [
                    kubernetes_asyncio.client.models.v1beta1/network_policy.v1beta1.NetworkPolicy(
                        api_version = '0', 
                        kind = '0', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '0', 
                            uid = '0', ), 
                        spec = kubernetes_asyncio.client.models.v1beta1/network_policy_spec.v1beta1.NetworkPolicySpec(
                            egress = [
                                kubernetes_asyncio.client.models.v1beta1/network_policy_egress_rule.v1beta1.NetworkPolicyEgressRule(
                                    ports = [
                                        kubernetes_asyncio.client.models.v1beta1/network_policy_port.v1beta1.NetworkPolicyPort(
                                            port = kubernetes_asyncio.client.models.port.port(), 
                                            protocol = '0', )
                                        ], 
                                    to = [
                                        kubernetes_asyncio.client.models.v1beta1/network_policy_peer.v1beta1.NetworkPolicyPeer(
                                            ip_block = kubernetes_asyncio.client.models.v1beta1/ip_block.v1beta1.IPBlock(
                                                cidr = '0', 
                                                except = [
                                                    '0'
                                                    ], ), 
                            ...
                            ingress = [
                                kubernetes_asyncio.client.models.v1beta1/network_policy_ingress_rule.v1beta1.NetworkPolicyIngressRule(
                                    from = [
                                        kubernetes_asyncio.client.models.v1beta1/network_policy_peer.v1beta1.NetworkPolicyPeer()
                                        ], )
                                ], 
