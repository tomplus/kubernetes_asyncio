...
from kubernetes_asyncio.client.api.scheduling_v1beta1_api import SchedulingV1beta1Api  # noqa: E501
...
class TestSchedulingV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes_asyncio.client.api.scheduling_v1beta1_api.SchedulingV1beta1Api()  # noqa: E501
