...
from kubernetes_asyncio.client.models.v1_csi_driver import V1CSIDriver  # noqa: E501
...
class TestV1CSIDriver(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1_csi_driver.V1CSIDriver()  # noqa: E501
        if include_optional :
            return V1CSIDriver(
                api_version = '', 
                kind = '', 
