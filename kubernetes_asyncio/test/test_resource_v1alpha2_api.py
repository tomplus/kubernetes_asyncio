...
class TestResourceV1alpha2Api(unittest.IsolatedAsyncioTestCase):
    ...
    def test_create_namespaced_resource_claim_parameters(self):
    ...
    def test_create_namespaced_resource_class_parameters(self):
    ...
    def test_delete_collection_namespaced_resource_claim_parameters(self):
    ...
    def test_delete_collection_namespaced_resource_class_parameters(self):
    ...
    def test_delete_namespaced_resource_claim_parameters(self):
    ...
    def test_delete_namespaced_resource_class_parameters(self):
    ...
    def test_list_namespaced_resource_claim_parameters(self):
    ...
    def test_list_namespaced_resource_class_parameters(self):
    ...
    def test_list_resource_claim_parameters_for_all_namespaces(self):
    ...
    def test_list_resource_class_parameters_for_all_namespaces(self):
    ...
    def test_patch_namespaced_resource_claim_parameters(self):
    ...
    def test_patch_namespaced_resource_class_parameters(self):
    ...
    def test_read_namespaced_resource_claim_parameters(self):
    ...
    def test_read_namespaced_resource_class_parameters(self):
    ...
    def test_replace_namespaced_resource_claim_parameters(self):
    ...
    def test_replace_namespaced_resource_class_parameters(self):
