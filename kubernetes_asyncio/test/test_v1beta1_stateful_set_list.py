...
from kubernetes_asyncio.client.models.v1beta1_stateful_set_list import V1beta1StatefulSetList  # noqa: E501
...
class TestV1beta1StatefulSetList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1beta1_stateful_set_list.V1beta1StatefulSetList()  # noqa: E501
        if include_optional :
            return V1beta1StatefulSetList(
                api_version = '0', 
                items = [
                    kubernetes_asyncio.client.models.v1beta1/stateful_set.v1beta1.StatefulSet(
                        api_version = '0', 
                        kind = '0', 
