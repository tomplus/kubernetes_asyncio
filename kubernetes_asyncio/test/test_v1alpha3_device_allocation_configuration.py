...
from kubernetes_asyncio.client.models.v1alpha3_device_allocation_configuration import V1alpha3DeviceAllocationConfiguration  # noqa: E501
...
class TestV1alpha3DeviceAllocationConfiguration(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1alpha3_device_allocation_configuration.V1alpha3DeviceAllocationConfiguration()  # noqa: E501
        if include_optional :
