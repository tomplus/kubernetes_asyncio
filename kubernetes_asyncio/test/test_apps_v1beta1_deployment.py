        ...
        if include_optional :
            return AppsV1beta1Deployment(
                ...
                metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                    ...
                    self_link = '0', 
                    uid = '0', ), 
                spec = kubernetes_asyncio.client.models.apps/v1beta1/deployment_spec.apps.v1beta1.DeploymentSpec(
                    min_ready_seconds = 56, 
                    paused = True, 
                    progress_deadline_seconds = 56, 
                    replicas = 56, 
                    revision_history_limit = 56, 
                    rollback_to = kubernetes_asyncio.client.models.apps/v1beta1/rollback_config.apps.v1beta1.RollbackConfig(
                        revision = 56, ), 
                    ...
                    strategy = kubernetes_asyncio.client.models.apps/v1beta1/deployment_strategy.apps.v1beta1.DeploymentStrategy(
                        rolling_update = kubernetes_asyncio.client.models.apps/v1beta1/rolling_update_deployment.apps.v1beta1.RollingUpdateDeployment(
                    ...
                    template = kubernetes_asyncio.client.models.v1/pod_template_spec.v1.PodTemplateSpec(
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '0', 
                            uid = '0', ), ), ), 
                status = kubernetes_asyncio.client.models.apps/v1beta1/deployment_status.apps.v1beta1.DeploymentStatus(
                    available_replicas = 56, 
                    collision_count = 56, 
                    conditions = [
                        kubernetes_asyncio.client.models.apps/v1beta1/deployment_condition.apps.v1beta1.DeploymentCondition(
