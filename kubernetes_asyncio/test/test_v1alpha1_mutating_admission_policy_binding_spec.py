...
from kubernetes_asyncio.client.models.v1alpha1_mutating_admission_policy_binding_spec import V1alpha1MutatingAdmissionPolicyBindingSpec  # noqa: E501
...
class TestV1alpha1MutatingAdmissionPolicyBindingSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1alpha1_mutating_admission_policy_binding_spec.V1alpha1MutatingAdmissionPolicyBindingSpec()  # noqa: E501
        if include_optional :
