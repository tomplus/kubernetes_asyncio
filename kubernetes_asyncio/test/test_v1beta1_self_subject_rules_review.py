        ...
        if include_optional :
            return V1beta1SelfSubjectRulesReview(
                ...
                metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                    ...
                    self_link = '0', 
                    uid = '0', ), 
                spec = kubernetes_asyncio.client.models.v1beta1/self_subject_rules_review_spec.v1beta1.SelfSubjectRulesReviewSpec(
                    namespace = '0', ), 
                status = kubernetes_asyncio.client.models.v1beta1/subject_rules_review_status.v1beta1.SubjectRulesReviewStatus(
                    evaluation_error = '0', 
                    incomplete = True, 
                    non_resource_rules = [
                        kubernetes_asyncio.client.models.v1beta1/non_resource_rule.v1beta1.NonResourceRule(
                            non_resource_ur_ls = [
                                '0'
                                ], 
                            verbs = [
                    ...
                    resource_rules = [
                        kubernetes_asyncio.client.models.v1beta1/resource_rule.v1beta1.ResourceRule(
                            api_groups = [
                                '0'
                                ], 
                            resource_names = [
