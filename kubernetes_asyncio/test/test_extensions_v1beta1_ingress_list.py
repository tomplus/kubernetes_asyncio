...
from kubernetes_asyncio.client.models.extensions_v1beta1_ingress_list import ExtensionsV1beta1IngressList  # noqa: E501
...
class TestExtensionsV1beta1IngressList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.extensions_v1beta1_ingress_list.ExtensionsV1beta1IngressList()  # noqa: E501
        if include_optional :
            return ExtensionsV1beta1IngressList(
                api_version = '0', 
                items = [
                    kubernetes_asyncio.client.models.extensions/v1beta1/ingress.extensions.v1beta1.Ingress(
                        api_version = '0', 
                        kind = '0', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '0', 
                            uid = '0', ), 
                        spec = kubernetes_asyncio.client.models.extensions/v1beta1/ingress_spec.extensions.v1beta1.IngressSpec(
                            backend = kubernetes_asyncio.client.models.extensions/v1beta1/ingress_backend.extensions.v1beta1.IngressBackend(
                                service_name = '0', 
                                service_port = kubernetes_asyncio.client.models.service_port.servicePort(), ), 
                            rules = [
                                kubernetes_asyncio.client.models.extensions/v1beta1/ingress_rule.extensions.v1beta1.IngressRule(
                                    host = '0', 
                                    http = kubernetes_asyncio.client.models.extensions/v1beta1/http_ingress_rule_value.extensions.v1beta1.HTTPIngressRuleValue(
                                        paths = [
                                            kubernetes_asyncio.client.models.extensions/v1beta1/http_ingress_path.extensions.v1beta1.HTTPIngressPath(
                                                backend = kubernetes_asyncio.client.models.extensions/v1beta1/ingress_backend.extensions.v1beta1.IngressBackend(
                                                    service_name = '0', 
                                                    service_port = kubernetes_asyncio.client.models.service_port.servicePort(), ), 
                                                path = '0', )
                            ...
                            tls = [
                                kubernetes_asyncio.client.models.extensions/v1beta1/ingress_tls.extensions.v1beta1.IngressTLS(
                                    hosts = [
                                        '0'
                                        ], 
                                    secret_name = '0', )
                                ], ), 
                        status = kubernetes_asyncio.client.models.extensions/v1beta1/ingress_status.extensions.v1beta1.IngressStatus(
