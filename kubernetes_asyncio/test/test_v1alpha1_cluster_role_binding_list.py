...
from kubernetes_asyncio.client.models.v1alpha1_cluster_role_binding_list import V1alpha1ClusterRoleBindingList  # noqa: E501
...
class TestV1alpha1ClusterRoleBindingList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1alpha1_cluster_role_binding_list.V1alpha1ClusterRoleBindingList()  # noqa: E501
        if include_optional :
            return V1alpha1ClusterRoleBindingList(
                api_version = '0', 
                items = [
                    kubernetes_asyncio.client.models.v1alpha1/cluster_role_binding.v1alpha1.ClusterRoleBinding(
                        api_version = '0', 
                        kind = '0', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '0', 
                            uid = '0', ), 
                        role_ref = kubernetes_asyncio.client.models.v1alpha1/role_ref.v1alpha1.RoleRef(
                            api_group = '0', 
                            kind = '0', 
                            name = '0', ), 
                        subjects = [
                            kubernetes_asyncio.client.models.v1alpha1/subject.v1alpha1.Subject(
                                api_version = '0', 
                                kind = '0', 
                                name = '0', 
                                namespace = '0', )
