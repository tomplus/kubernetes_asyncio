...
from kubernetes_asyncio.client.models.v1beta1_certificate_signing_request_list import V1beta1CertificateSigningRequestList  # noqa: E501
...
class TestV1beta1CertificateSigningRequestList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1beta1_certificate_signing_request_list.V1beta1CertificateSigningRequestList()  # noqa: E501
        if include_optional :
            return V1beta1CertificateSigningRequestList(
                api_version = '0', 
                items = [
                    kubernetes_asyncio.client.models.v1beta1/certificate_signing_request.v1beta1.CertificateSigningRequest(
                        api_version = '0', 
                        kind = '0', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '0', 
                            uid = '0', ), 
                        spec = kubernetes_asyncio.client.models.v1beta1/certificate_signing_request_spec.v1beta1.CertificateSigningRequestSpec(
                            extra = {
                                'key' : [
                                    '0'
                                    ]
                            ...
                            username = '0', ), 
                        status = kubernetes_asyncio.client.models.v1beta1/certificate_signing_request_status.v1beta1.CertificateSigningRequestStatus(
                            certificate = 'YQ==', 
                            conditions = [
                                kubernetes_asyncio.client.models.v1beta1/certificate_signing_request_condition.v1beta1.CertificateSigningRequestCondition(
