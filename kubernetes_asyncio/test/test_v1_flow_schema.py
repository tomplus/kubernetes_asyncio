...
from kubernetes_asyncio.client.models.v1_flow_schema import V1FlowSchema  # noqa: E501
...
class TestV1FlowSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1_flow_schema.V1FlowSchema()  # noqa: E501
        if include_optional :
            return V1FlowSchema(
                api_version = '', 
                kind = '', 
