...
from kubernetes_asyncio.client.models.v1beta1_cron_job_list import V1beta1CronJobList  # noqa: E501
...
class TestV1beta1CronJobList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes_asyncio.client.models.v1beta1_cron_job_list.V1beta1CronJobList()  # noqa: E501
        if include_optional :
            return V1beta1CronJobList(
                api_version = '0', 
                items = [
                    kubernetes_asyncio.client.models.v1beta1/cron_job.v1beta1.CronJob(
                        api_version = '0', 
                        kind = '0', 
                        metadata = kubernetes_asyncio.client.models.v1/object_meta.v1.ObjectMeta(
                            ...
                            self_link = '0', 
                            uid = '0', ), 
                        spec = kubernetes_asyncio.client.models.v1beta1/cron_job_spec.v1beta1.CronJobSpec(
                            concurrency_policy = '0', 
                            failed_jobs_history_limit = 56, 
                            job_template = kubernetes_asyncio.client.models.v1beta1/job_template_spec.v1beta1.JobTemplateSpec(), 
                            schedule = '0', 
                            starting_deadline_seconds = 56, 
                            successful_jobs_history_limit = 56, 
                            suspend = True, ), 
                        status = kubernetes_asyncio.client.models.v1beta1/cron_job_status.v1beta1.CronJobStatus(
                            active = [
