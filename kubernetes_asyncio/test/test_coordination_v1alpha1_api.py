...
from kubernetes_asyncio.client.api.coordination_v1alpha1_api import CoordinationV1alpha1Api  # noqa: E501
...
class TestCoordinationV1alpha1Api(unittest.IsolatedAsyncioTestCase):
    ...
    async def asyncSetUp(self):
        self.api = kubernetes_asyncio.client.api.coordination_v1alpha1_api.CoordinationV1alpha1Api()  # noqa: E501
