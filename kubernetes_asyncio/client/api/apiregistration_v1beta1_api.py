...
class ApiregistrationV1beta1Api(object):
    ...
    def patch_api_service_status(self, name, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.patch_api_service_status_with_http_info(name, body, **kwargs)  # noqa: E501
            return data
    ...
    def patch_api_service_status_with_http_info(self, name, body, **kwargs):  # noqa: E501
        ...
        if ('body' not in local_var_params or
                local_var_params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_api_service_status`")  # noqa: E501
