...
class CoordinationV1beta1Api(object):
    ...
    def create_namespaced_lease(self, namespace, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.create_namespaced_lease_with_http_info(namespace, body, **kwargs)  # noqa: E501
            return data
    ...
    def create_namespaced_lease_with_http_info(self, namespace, body, **kwargs):  # noqa: E501
        ...
        if ('body' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `body` when calling `create_namespaced_lease`")  # noqa: E501
    ...
    def delete_namespaced_lease(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_namespaced_lease_with_http_info(name, namespace, body, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_namespaced_lease_with_http_info(name, namespace, body, **kwargs)  # noqa: E501
            return data

    def delete_namespaced_lease_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        """delete_namespaced_lease  # noqa: E501
        ...
        if ('body' not in local_var_params or
                local_var_params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `delete_namespaced_lease`")  # noqa: E501
    ...
    def patch_namespaced_lease(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.patch_namespaced_lease_with_http_info(name, namespace, body, **kwargs)  # noqa: E501
            return data
    ...
    def patch_namespaced_lease_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        if ('body' not in local_var_params or
                local_var_params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_namespaced_lease`")  # noqa: E501
    ...
    def replace_namespaced_lease_with_http_info(self, name, namespace, body, **kwargs):  # noqa: E501
        ...
        if ('body' not in local_var_params or
                local_var_params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `replace_namespaced_lease`")  # noqa: E501
