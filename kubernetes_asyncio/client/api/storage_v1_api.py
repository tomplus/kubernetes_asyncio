...
class StorageV1Api(object):
    ...
    def patch_volume_attachment_status(self, name, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.patch_volume_attachment_status_with_http_info(name, body, **kwargs)  # noqa: E501
            return data
    ...
    def patch_volume_attachment_status_with_http_info(self, name, body, **kwargs):  # noqa: E501
        ...
        if ('name' not in local_var_params or
                local_var_params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `patch_volume_attachment_status`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in local_var_params or
                local_var_params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_volume_attachment_status`")  # noqa: E501
    ...
    def read_volume_attachment_status_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        if ('name' not in local_var_params or
                local_var_params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `read_volume_attachment_status`")  # noqa: E501
    ...
    def replace_volume_attachment_status_with_http_info(self, name, body, **kwargs):  # noqa: E501
        ...
        if ('name' not in local_var_params or
                local_var_params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `replace_volume_attachment_status`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in local_var_params or
                local_var_params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `replace_volume_attachment_status`")  # noqa: E501
