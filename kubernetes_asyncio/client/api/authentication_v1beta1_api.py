...
class AuthenticationV1beta1Api(object):
    ...
    def create_token_review_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(V1beta1TokenReview, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "V1beta1TokenReview",
            201: "V1beta1TokenReview",
            202: "V1beta1TokenReview",
            401: None,
        }
