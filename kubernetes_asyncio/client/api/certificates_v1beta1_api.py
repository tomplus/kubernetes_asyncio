...
class CertificatesV1beta1Api(object):
    ...
    def create_certificate_signing_request(self, body, **kwargs):  # noqa: E501
        ...
        :param body: (required)
        :type body: V1beta1CertificateSigningRequest
        ...
        :rtype: V1beta1CertificateSigningRequest
        """
    ...
    def create_certificate_signing_request_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(V1beta1CertificateSigningRequest, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "V1beta1CertificateSigningRequest",
            201: "V1beta1CertificateSigningRequest",
            202: "V1beta1CertificateSigningRequest",
            401: None,
        }
    ...
    def list_certificate_signing_request(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: V1beta1CertificateSigningRequestList
        """
        kwargs['_return_http_data_only'] = True
    ...
    def list_certificate_signing_request_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(V1beta1CertificateSigningRequestList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "V1beta1CertificateSigningRequestList",
            401: None,
        }
    ...
    def patch_certificate_signing_request_approval_with_http_info(self, name, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}/approval', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_certificate_signing_request_approval_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}/approval', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
