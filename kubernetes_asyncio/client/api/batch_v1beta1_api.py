...
class BatchV1beta1Api(object):
    ...
    def create_namespaced_cron_job_with_http_info(self, namespace, body, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(V1beta1CronJob, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def list_cron_job_for_all_namespaces_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(V1beta1CronJobList, status_code(int), headers(HTTPHeaderDict))
        """
