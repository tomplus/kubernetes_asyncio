...
class AdmissionregistrationV1alpha1Api(object):
    ...
    def delete_initializer_configuration(self, name, **kwargs):  # noqa: E501
    ...
    def delete_initializer_configuration_with_http_info(self, name, **kwargs):  # noqa: E501
        """delete_initializer_configuration  # noqa: E501

        delete an InitializerConfiguration  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_initializer_configuration_with_http_info(name, async_req=True)
        >>> result = thread.get()
