...
class NetworkingV1beta1Api(object):
    ...
    def create_ingress_class_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(V1beta1IngressClass, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "V1beta1IngressClass",
            201: "V1beta1IngressClass",
            202: "V1beta1IngressClass",
            401: None,
        }

        return self.api_client.call_api(
            '/apis/networking.k8s.io/v1beta1/ingressclasses', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_namespaced_ingress(self, namespace, body, **kwargs):  # noqa: E501
        ...
        :type namespace: str
        :param body: (required)
        :type body: NetworkingV1beta1Ingress
        :param pretty: If 'true', then the output is pretty printed.
        :type pretty: str
        :param dry_run: When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
        :type dry_run: str
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: NetworkingV1beta1Ingress
        """
        kwargs['_return_http_data_only'] = True
    ...
    def create_namespaced_ingress_with_http_info(self, namespace, body, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(NetworkingV1beta1Ingress, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "NetworkingV1beta1Ingress",
            201: "NetworkingV1beta1Ingress",
            202: "NetworkingV1beta1Ingress",
            401: None,
        }
    ...
    def delete_collection_ingress_class_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/networking.k8s.io/v1beta1/ingressclasses', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_ingress_class_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/networking.k8s.io/v1beta1/ingressclasses/{name}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_ingress_class_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(V1beta1IngressClassList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "V1beta1IngressClassList",
            401: None,
        }

        return self.api_client.call_api(
            '/apis/networking.k8s.io/v1beta1/ingressclasses', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_ingress_for_all_namespaces(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: NetworkingV1beta1IngressList
        """
        kwargs['_return_http_data_only'] = True
    ...
    def list_ingress_for_all_namespaces_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(NetworkingV1beta1IngressList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "NetworkingV1beta1IngressList",
            401: None,
        }
    ...
    def patch_ingress_class_with_http_info(self, name, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/networking.k8s.io/v1beta1/ingressclasses/{name}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_ingress_class_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/networking.k8s.io/v1beta1/ingressclasses/{name}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def replace_ingress_class_with_http_info(self, name, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/networking.k8s.io/v1beta1/ingressclasses/{name}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
