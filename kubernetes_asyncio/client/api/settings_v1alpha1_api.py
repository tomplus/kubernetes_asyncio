...
class SettingsV1alpha1Api(object):
    ...
    def delete_namespaced_pod_preset_with_http_info(self, name, namespace, **kwargs):  # noqa: E501
        """delete_namespaced_pod_preset  # noqa: E501

        delete a PodPreset  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_namespaced_pod_preset_with_http_info(name, namespace, async_req=True)
        >>> result = thread.get()
