...
class ExtensionsV1beta1Api(object):
    ...
    def delete_namespaced_ingress(self, name, namespace, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_namespaced_ingress_with_http_info(name, namespace, **kwargs)  # noqa: E501
            return data
    ...
    def delete_namespaced_network_policy(self, name, namespace, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_namespaced_network_policy_with_http_info(name, namespace, **kwargs)  # noqa: E501
            return data
