...
class PolicyV1beta1Api(object):
    ...
    def create_namespaced_pod_disruption_budget(self, namespace, body, **kwargs):  # noqa: E501
        ...
        :type namespace: str
        :param body: (required)
        :type body: V1beta1PodDisruptionBudget
        ...
        :rtype: V1beta1PodDisruptionBudget
        """
    ...
    def create_namespaced_pod_disruption_budget_with_http_info(self, namespace, body, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(V1beta1PodDisruptionBudget, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "V1beta1PodDisruptionBudget",
            201: "V1beta1PodDisruptionBudget",
            202: "V1beta1PodDisruptionBudget",
            401: None,
        }
    ...
    def create_pod_security_policy(self, body, **kwargs):  # noqa: E501
        ...
        :param body: (required)
        :type body: V1beta1PodSecurityPolicy
        :param pretty: If 'true', then the output is pretty printed.
        :type pretty: str
        :param dry_run: When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
        :type dry_run: str
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: V1beta1PodSecurityPolicy
        """
        kwargs['_return_http_data_only'] = True
    ...
    def create_pod_security_policy_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(V1beta1PodSecurityPolicy, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "V1beta1PodSecurityPolicy",
            201: "V1beta1PodSecurityPolicy",
            202: "V1beta1PodSecurityPolicy",
            401: None,
        }
    ...
    def list_namespaced_pod_disruption_budget(self, namespace, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: V1beta1PodDisruptionBudgetList
        """
        kwargs['_return_http_data_only'] = True
    ...
    def list_namespaced_pod_disruption_budget_with_http_info(self, namespace, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(V1beta1PodDisruptionBudgetList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "V1beta1PodDisruptionBudgetList",
            401: None,
        }
    ...
    def list_pod_security_policy(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: V1beta1PodSecurityPolicyList
        """
        kwargs['_return_http_data_only'] = True
    ...
    def list_pod_security_policy_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(V1beta1PodSecurityPolicyList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        response_types_map = {
            200: "V1beta1PodSecurityPolicyList",
            401: None,
        }
