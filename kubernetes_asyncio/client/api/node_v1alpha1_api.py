...
class NodeV1alpha1Api(object):
    ...
    def create_runtime_class(self, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.create_runtime_class_with_http_info(body, **kwargs)  # noqa: E501
            return data
    ...
    def create_runtime_class_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if ('body' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `body` when calling `create_runtime_class`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='V1alpha1RuntimeClass',  # noqa: E501
    ...
    def delete_collection_runtime_class(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_collection_runtime_class_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def delete_runtime_class(self, name, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_runtime_class_with_http_info(name, **kwargs)  # noqa: E501
            return data
    ...
    def delete_runtime_class_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        if ('name' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `name` when calling `delete_runtime_class`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_runtime_class(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.list_runtime_class_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def list_runtime_class_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='V1alpha1RuntimeClassList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def patch_runtime_class(self, name, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.patch_runtime_class_with_http_info(name, body, **kwargs)  # noqa: E501
            return data
    ...
    def patch_runtime_class_with_http_info(self, name, body, **kwargs):  # noqa: E501
        ...
        if ('name' not in local_var_params or
                local_var_params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `patch_runtime_class`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in local_var_params or
                local_var_params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_runtime_class`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_runtime_class(self, name, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.read_runtime_class_with_http_info(name, **kwargs)  # noqa: E501
            return data
    ...
    def read_runtime_class_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        if ('name' not in local_var_params or
                local_var_params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `read_runtime_class`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def replace_runtime_class(self, name, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.replace_runtime_class_with_http_info(name, body, **kwargs)  # noqa: E501
            return data
    ...
    def replace_runtime_class_with_http_info(self, name, body, **kwargs):  # noqa: E501
        ...
        if ('name' not in local_var_params or
                local_var_params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `replace_runtime_class`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in local_var_params or
                local_var_params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `replace_runtime_class`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
