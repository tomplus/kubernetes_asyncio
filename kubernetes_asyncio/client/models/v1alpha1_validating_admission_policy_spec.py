...
class V1alpha1ValidatingAdmissionPolicySpec(object):
    ...
    def __init__(self, audit_annotations=None, failure_policy=None, match_conditions=None, match_constraints=None, param_kind=None, validations=None, local_vars_configuration=None):  # noqa: E501
