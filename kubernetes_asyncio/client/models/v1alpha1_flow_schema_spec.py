...
class V1alpha1FlowSchemaSpec(object):
    ...
    def __init__(self, distinguisher_method=None, matching_precedence=None, priority_level_configuration=None, rules=None, local_vars_configuration=None):  # noqa: E501
        """V1alpha1FlowSchemaSpec - a model defined in OpenAPI"""  # noqa: E501
    ...
    def distinguisher_method(self):
        """Gets the distinguisher_method of this V1alpha1FlowSchemaSpec.  # noqa: E501


        :return: The distinguisher_method of this V1alpha1FlowSchemaSpec.  # noqa: E501
        :rtype: V1alpha1FlowDistinguisherMethod
        """
        return self._distinguisher_method

    @distinguisher_method.setter
    def distinguisher_method(self, distinguisher_method):
        """Sets the distinguisher_method of this V1alpha1FlowSchemaSpec.


        :param distinguisher_method: The distinguisher_method of this V1alpha1FlowSchemaSpec.  # noqa: E501
    ...
    def matching_precedence(self):
        """Gets the matching_precedence of this V1alpha1FlowSchemaSpec.  # noqa: E501
        ...
        :return: The matching_precedence of this V1alpha1FlowSchemaSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def matching_precedence(self, matching_precedence):
        """Sets the matching_precedence of this V1alpha1FlowSchemaSpec.

        `matchingPrecedence` is used to choose among the FlowSchemas that match a given request. The chosen FlowSchema is among those with the numerically lowest (which we take to be logically highest) MatchingPrecedence.  Each MatchingPrecedence value must be ranged in [1,10000]. Note that if the precedence is not specified, it will be set to 1000 as default.  # noqa: E501

        :param matching_precedence: The matching_precedence of this V1alpha1FlowSchemaSpec.  # noqa: E501
        :type: int
        """
    ...
    def priority_level_configuration(self):
        """Gets the priority_level_configuration of this V1alpha1FlowSchemaSpec.  # noqa: E501


        :return: The priority_level_configuration of this V1alpha1FlowSchemaSpec.  # noqa: E501
        :rtype: V1alpha1PriorityLevelConfigurationReference
        """
    ...
    def priority_level_configuration(self, priority_level_configuration):
        """Sets the priority_level_configuration of this V1alpha1FlowSchemaSpec.


        :param priority_level_configuration: The priority_level_configuration of this V1alpha1FlowSchemaSpec.  # noqa: E501
    ...
    @property
    def rules(self):
        """Gets the rules of this V1alpha1FlowSchemaSpec.  # noqa: E501
        ...
        :return: The rules of this V1alpha1FlowSchemaSpec.  # noqa: E501
        :rtype: list[V1alpha1PolicyRulesWithSubjects]
        """
        return self._rules

    @rules.setter
    def rules(self, rules):
        """Sets the rules of this V1alpha1FlowSchemaSpec.

        `rules` describes which requests will match this flow schema. This FlowSchema matches a request if and only if at least one member of rules matches the request. if it is an empty slice, there will be no requests matching the FlowSchema.  # noqa: E501

        :param rules: The rules of this V1alpha1FlowSchemaSpec.  # noqa: E501
        :type: list[V1alpha1PolicyRulesWithSubjects]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1FlowSchemaSpec):
            return False
