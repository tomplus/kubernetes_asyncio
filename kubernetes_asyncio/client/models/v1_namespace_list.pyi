...
class V1NamespaceList:
    ...
    def __init__(self, api_version: str, items: list[V1Namespace], kind: str, metadata: V1ListMeta, local_vars_configuration: Any) -> None: ...
    ...
    @items.setter
    def items(self, items: list[V1Namespace]) -> None: ...
    @property
    def kind(self) -> str: ...
    @kind.setter
