...
class V1APIVersions(object):
    ...
    def __init__(self, api_version=None, kind=None, server_address_by_client_cid_rs=None, versions=None):  # noqa: E501
        """V1APIVersions - a model defined in Swagger"""  # noqa: E501
