...
class V1alpha1ResourcePolicyRule(object):
    ...
    def __init__(self, api_groups=None, cluster_scope=None, namespaces=None, resources=None, verbs=None, local_vars_configuration=None):  # noqa: E501
        """V1alpha1ResourcePolicyRule - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def api_groups(self):
        """Gets the api_groups of this V1alpha1ResourcePolicyRule.  # noqa: E501
        ...
        :return: The api_groups of this V1alpha1ResourcePolicyRule.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def api_groups(self, api_groups):
        """Sets the api_groups of this V1alpha1ResourcePolicyRule.

        `apiGroups` is a list of matching API groups and may not be empty. \"*\" matches all API groups and, if present, must be the only entry. Required.  # noqa: E501

        :param api_groups: The api_groups of this V1alpha1ResourcePolicyRule.  # noqa: E501
        :type: list[str]
        """
    ...
    def cluster_scope(self):
        """Gets the cluster_scope of this V1alpha1ResourcePolicyRule.  # noqa: E501
        ...
        :return: The cluster_scope of this V1alpha1ResourcePolicyRule.  # noqa: E501
        :rtype: bool
        """
    ...
    def cluster_scope(self, cluster_scope):
        """Sets the cluster_scope of this V1alpha1ResourcePolicyRule.

        `clusterScope` indicates whether to match requests that do not specify a namespace (which happens either because the resource is not namespaced or the request targets all namespaces). If this field is omitted or false then the `namespaces` field must contain a non-empty list.  # noqa: E501

        :param cluster_scope: The cluster_scope of this V1alpha1ResourcePolicyRule.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def namespaces(self):
        """Gets the namespaces of this V1alpha1ResourcePolicyRule.  # noqa: E501
        ...
        :return: The namespaces of this V1alpha1ResourcePolicyRule.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def namespaces(self, namespaces):
        """Sets the namespaces of this V1alpha1ResourcePolicyRule.

        `namespaces` is a list of target namespaces that restricts matches.  A request that specifies a target namespace matches only if either (a) this list contains that target namespace or (b) this list contains \"*\".  Note that \"*\" matches any specified namespace but does not match a request that _does not specify_ a namespace (see the `clusterScope` field for that). This list may be empty, but only if `clusterScope` is true.  # noqa: E501

        :param namespaces: The namespaces of this V1alpha1ResourcePolicyRule.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def resources(self):
        """Gets the resources of this V1alpha1ResourcePolicyRule.  # noqa: E501
        ...
        :return: The resources of this V1alpha1ResourcePolicyRule.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def resources(self, resources):
        """Sets the resources of this V1alpha1ResourcePolicyRule.

        `resources` is a list of matching resources (i.e., lowercase and plural) with, if desired, subresource.  For example, [ \"services\", \"nodes/status\" ].  This list may not be empty. \"*\" matches all resources and, if present, must be the only entry. Required.  # noqa: E501

        :param resources: The resources of this V1alpha1ResourcePolicyRule.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def verbs(self):
        """Gets the verbs of this V1alpha1ResourcePolicyRule.  # noqa: E501
        ...
        :return: The verbs of this V1alpha1ResourcePolicyRule.  # noqa: E501
        :rtype: list[str]
        """
        return self._verbs
    ...
    def verbs(self, verbs):
        """Sets the verbs of this V1alpha1ResourcePolicyRule.

        `verbs` is a list of matching verbs and may not be empty. \"*\" matches all verbs and, if present, must be the only entry. Required.  # noqa: E501

        :param verbs: The verbs of this V1alpha1ResourcePolicyRule.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1ResourcePolicyRule):
            return False
