...
class V1beta1CustomResourceSubresourceScale(object):
    ...
    def __init__(self, label_selector_path=None, spec_replicas_path=None, status_replicas_path=None, local_vars_configuration=None):  # noqa: E501
        """V1beta1CustomResourceSubresourceScale - a model defined in OpenAPI"""  # noqa: E501
    ...
    def label_selector_path(self):
        """Gets the label_selector_path of this V1beta1CustomResourceSubresourceScale.  # noqa: E501

        LabelSelectorPath defines the JSON path inside of a CustomResource that corresponds to Scale.Status.Selector. Only JSON paths without the array notation are allowed. Must be a JSON Path under .status or .spec. Must be set to work with HPA. The field pointed by this JSON path must be a string field (not a complex selector struct) which contains a serialized label selector in string form. More info: https://kubernetes.io/docs/tasks/access-kubernetes-api/custom-resources/custom-resource-definitions#scale-subresource If there is no value under the given path in the CustomResource, the status label selector value in the /scale subresource will default to the empty string.  # noqa: E501

        :return: The label_selector_path of this V1beta1CustomResourceSubresourceScale.  # noqa: E501
        :rtype: str
        """
    ...
    def label_selector_path(self, label_selector_path):
        ...
        :param label_selector_path: The label_selector_path of this V1beta1CustomResourceSubresourceScale.  # noqa: E501
        :type: str
        """
    ...
    def spec_replicas_path(self):
        """Gets the spec_replicas_path of this V1beta1CustomResourceSubresourceScale.  # noqa: E501
        ...
        :return: The spec_replicas_path of this V1beta1CustomResourceSubresourceScale.  # noqa: E501
        :rtype: str
        """
    ...
    def spec_replicas_path(self, spec_replicas_path):
        ...
        :param spec_replicas_path: The spec_replicas_path of this V1beta1CustomResourceSubresourceScale.  # noqa: E501
        :type: str
        """
    ...
    def status_replicas_path(self):
        """Gets the status_replicas_path of this V1beta1CustomResourceSubresourceScale.  # noqa: E501
        ...
        :return: The status_replicas_path of this V1beta1CustomResourceSubresourceScale.  # noqa: E501
        :rtype: str
        """
    ...
    def status_replicas_path(self, status_replicas_path):
        ...
        :param status_replicas_path: The status_replicas_path of this V1beta1CustomResourceSubresourceScale.  # noqa: E501
        :type: str
        """
