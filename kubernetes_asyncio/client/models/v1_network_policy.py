...
class V1NetworkPolicy(object):
    ...
    @property
    def status(self):
        """Gets the status of this V1NetworkPolicy.  # noqa: E501


        :return: The status of this V1NetworkPolicy.  # noqa: E501
        :rtype: V1NetworkPolicyStatus
        """
        return self._status

    @status.setter
    def status(self, status):
        """Sets the status of this V1NetworkPolicy.


        :param status: The status of this V1NetworkPolicy.  # noqa: E501
        :type status: V1NetworkPolicyStatus
        """
