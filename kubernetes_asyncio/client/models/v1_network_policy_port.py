...
class V1NetworkPolicyPort(object):
    ...
    def __init__(self, port=None, protocol=None):  # noqa: E501
        """V1NetworkPolicyPort - a model defined in Swagger"""  # noqa: E501
    ...
    def protocol(self):
        ...
        The protocol (TCP or UDP) which traffic must match. If not specified, this field defaults to TCP.  # noqa: E501
