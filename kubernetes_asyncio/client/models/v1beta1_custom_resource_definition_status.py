...
class V1beta1CustomResourceDefinitionStatus(object):
    ...
    def accepted_names(self, accepted_names):
        ...
        """
        if self.local_vars_configuration.client_side_validation and accepted_names is None:  # noqa: E501
    ...
    def stored_versions(self, stored_versions):
        ...
        :type: list[str]
        """
        if self.local_vars_configuration.client_side_validation and stored_versions is None:  # noqa: E501
