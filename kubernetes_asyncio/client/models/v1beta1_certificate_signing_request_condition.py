...
class V1beta1CertificateSigningRequestCondition(object):
    ...
    def last_transition_time(self):
        """Gets the last_transition_time of this V1beta1CertificateSigningRequestCondition.  # noqa: E501
        ...
        :return: The last_transition_time of this V1beta1CertificateSigningRequestCondition.  # noqa: E501
        :rtype: datetime
        """
    ...
    def last_transition_time(self, last_transition_time):
        """Sets the last_transition_time of this V1beta1CertificateSigningRequestCondition.

        lastTransitionTime is the time the condition last transitioned from one status to another. If unset, when a new condition type is added or an existing condition's status is changed, the server defaults this to the current time.  # noqa: E501

        :param last_transition_time: The last_transition_time of this V1beta1CertificateSigningRequestCondition.  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this V1beta1CertificateSigningRequestCondition.  # noqa: E501

        Status of the condition, one of True, False, Unknown. Approved, Denied, and Failed conditions may not be \"False\" or \"Unknown\". Defaults to \"True\". If unset, should be treated as \"True\".  # noqa: E501

        :return: The status of this V1beta1CertificateSigningRequestCondition.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this V1beta1CertificateSigningRequestCondition.

        Status of the condition, one of True, False, Unknown. Approved, Denied, and Failed conditions may not be \"False\" or \"Unknown\". Defaults to \"True\". If unset, should be treated as \"True\".  # noqa: E501

        :param status: The status of this V1beta1CertificateSigningRequestCondition.  # noqa: E501
        :type status: str
        """
    ...
    def type(self):
        ...
        type of the condition. Known conditions include \"Approved\", \"Denied\", and \"Failed\".  # noqa: E501
