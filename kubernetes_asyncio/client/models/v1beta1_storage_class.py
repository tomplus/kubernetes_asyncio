...
class V1beta1StorageClass(object):
    ...
    def __init__(self, allow_volume_expansion=None, allowed_topologies=None, api_version=None, kind=None, metadata=None, mount_options=None, parameters=None, provisioner=None, reclaim_policy=None, volume_binding_mode=None):  # noqa: E501
        """V1beta1StorageClass - a model defined in Swagger"""  # noqa: E501
    ...
    def allowed_topologies(self):
        ...
        Restrict the node topologies where volumes can be dynamically provisioned. Each volume plugin defines its own supported topology specifications. An empty TopologySelectorTerm list means there is no topology restriction. This field is alpha-level and is only honored by servers that enable the DynamicProvisioningScheduling feature.  # noqa: E501
    ...
    def volume_binding_mode(self):
        ...
        VolumeBindingMode indicates how PersistentVolumeClaims should be provisioned and bound.  When unset, VolumeBindingImmediate is used. This field is alpha-level and is only honored by servers that enable the VolumeScheduling feature.  # noqa: E501
