...
class ApiregistrationV1beta1ServiceReference(object):
    ...
    def __init__(self, name=None, namespace=None, port=None, local_vars_configuration=None):  # noqa: E501
        """ApiregistrationV1beta1ServiceReference - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def port(self):
        """Gets the port of this ApiregistrationV1beta1ServiceReference.  # noqa: E501
        ...
        :return: The port of this ApiregistrationV1beta1ServiceReference.  # noqa: E501
        :rtype: int
        """
        return self._port
    ...
    @port.setter
    def port(self, port):
        """Sets the port of this ApiregistrationV1beta1ServiceReference.

        If specified, the port on the service that hosting webhook. Default to 443 for backward compatibility. `port` should be a valid port number (1-65535, inclusive).  # noqa: E501

        :param port: The port of this ApiregistrationV1beta1ServiceReference.  # noqa: E501
        :type: int
        """
