...
class V1beta1CustomResourceDefinitionSpec(object):
    ...
    def preserve_unknown_fields(self):
        ...
        preserveUnknownFields disables pruning of object fields which are not specified in the OpenAPI schema. apiVersion, kind, metadata and known fields inside metadata are always preserved. Defaults to true in v1beta and will default to false in v1.  # noqa: E501
