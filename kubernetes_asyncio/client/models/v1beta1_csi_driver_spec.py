...
class V1beta1CSIDriverSpec(object):
    ...
    def __init__(self, attach_required=None, fs_group_policy=None, pod_info_on_mount=None, storage_capacity=None, volume_lifecycle_modes=None, local_vars_configuration=None):  # noqa: E501
