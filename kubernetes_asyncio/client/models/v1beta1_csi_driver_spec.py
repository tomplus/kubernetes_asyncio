...
class V1beta1CSIDriverSpec(object):
    ...
    openapi_types = {
        ...
        'token_requests': 'list[V1beta1TokenRequest]',
    ...
    def fs_group_policy(self):
        """Gets the fs_group_policy of this V1beta1CSIDriverSpec.  # noqa: E501

        Defines if the underlying volume supports changing ownership and permission of the volume before being mounted. Refer to the specific FSGroupPolicy values for additional details. This field is alpha-level, and is only honored by servers that enable the CSIVolumeFSGroupPolicy feature gate.  This field is immutable.  # noqa: E501

        :return: The fs_group_policy of this V1beta1CSIDriverSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def requires_republish(self, requires_republish):
        """Sets the requires_republish of this V1beta1CSIDriverSpec.

        RequiresRepublish indicates the CSI driver wants `NodePublishVolume` being periodically called to reflect any possible change in the mounted volume. This field defaults to false.  Note: After a successful initial NodePublishVolume call, subsequent calls to NodePublishVolume should only update the contents of the volume. New mount points will not be seen by a running container.  This is a beta feature and only available when the CSIServiceAccountToken feature is enabled.  # noqa: E501

        :param requires_republish: The requires_republish of this V1beta1CSIDriverSpec.  # noqa: E501
    ...
    def storage_capacity(self):
        """Gets the storage_capacity of this V1beta1CSIDriverSpec.  # noqa: E501
        ...
        :return: The storage_capacity of this V1beta1CSIDriverSpec.  # noqa: E501
        :rtype: bool
        """
    ...
    def storage_capacity(self, storage_capacity):
        """Sets the storage_capacity of this V1beta1CSIDriverSpec.

        If set to true, storageCapacity indicates that the CSI volume driver wants pod scheduling to consider the storage capacity that the driver deployment will report by creating CSIStorageCapacity objects with capacity information.  The check can be enabled immediately when deploying a driver. In that case, provisioning new volumes with late binding will pause until the driver deployment has published some suitable CSIStorageCapacity object.  Alternatively, the driver can be deployed with the field unset or false and it can be flipped later when storage capacity information has been published.  This field is immutable.  This is a beta field and only available when the CSIStorageCapacity feature is enabled. The default is false.  # noqa: E501

        :param storage_capacity: The storage_capacity of this V1beta1CSIDriverSpec.  # noqa: E501
    ...
    def token_requests(self):
        """Gets the token_requests of this V1beta1CSIDriverSpec.  # noqa: E501
        ...
        :return: The token_requests of this V1beta1CSIDriverSpec.  # noqa: E501
        :rtype: list[V1beta1TokenRequest]
        """
        return self._token_requests

    @token_requests.setter
    def token_requests(self, token_requests):
        """Sets the token_requests of this V1beta1CSIDriverSpec.

        TokenRequests indicates the CSI driver needs pods' service account tokens it is mounting volume for to do necessary authentication. Kubelet will pass the tokens in VolumeContext in the CSI NodePublishVolume calls. The CSI driver should parse and validate the following VolumeContext: \"csi.storage.k8s.io/serviceAccount.tokens\": {   \"<audience>\": {     \"token\": <token>,     \"expirationTimestamp\": <expiration timestamp in RFC3339>,   },   ... }  Note: Audience in each TokenRequest should be different and at most one token is empty string. To receive a new token after expiry, RequiresRepublish can be used to trigger NodePublishVolume periodically.  This is a beta feature and only available when the CSIServiceAccountToken feature is enabled.  # noqa: E501

        :param token_requests: The token_requests of this V1beta1CSIDriverSpec.  # noqa: E501
        :type token_requests: list[V1beta1TokenRequest]
        """
