...
class V1PodSecurityContext(object):
    ...
    def __init__(self, fs_group=None, run_as_group=None, run_as_non_root=None, run_as_user=None, se_linux_options=None, supplemental_groups=None, sysctls=None):  # noqa: E501
