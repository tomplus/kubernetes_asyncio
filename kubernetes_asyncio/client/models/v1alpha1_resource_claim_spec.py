...
class V1alpha1ResourceClaimSpec(object):
    ...
    openapi_types = {
        'allocation_mode': 'str',
        'parameters_ref': 'V1alpha1ResourceClaimParametersReference',
    ...
    def __init__(self, allocation_mode=None, parameters_ref=None, resource_class_name=None, local_vars_configuration=None):  # noqa: E501
        """V1alpha1ResourceClaimSpec - a model defined in OpenAPI"""  # noqa: E501
    ...
    def allocation_mode(self):
        """Gets the allocation_mode of this V1alpha1ResourceClaimSpec.  # noqa: E501

        Allocation can start immediately or when a Pod wants to use the resource. \"WaitForFirstConsumer\" is the default.  # noqa: E501

        :return: The allocation_mode of this V1alpha1ResourceClaimSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def allocation_mode(self, allocation_mode):
        """Sets the allocation_mode of this V1alpha1ResourceClaimSpec.

        Allocation can start immediately or when a Pod wants to use the resource. \"WaitForFirstConsumer\" is the default.  # noqa: E501

        :param allocation_mode: The allocation_mode of this V1alpha1ResourceClaimSpec.  # noqa: E501
    ...
    def parameters_ref(self):
        """Gets the parameters_ref of this V1alpha1ResourceClaimSpec.  # noqa: E501


        :return: The parameters_ref of this V1alpha1ResourceClaimSpec.  # noqa: E501
        :rtype: V1alpha1ResourceClaimParametersReference
        """
        return self._parameters_ref

    @parameters_ref.setter
    def parameters_ref(self, parameters_ref):
        """Sets the parameters_ref of this V1alpha1ResourceClaimSpec.


        :param parameters_ref: The parameters_ref of this V1alpha1ResourceClaimSpec.  # noqa: E501
        :type parameters_ref: V1alpha1ResourceClaimParametersReference
        """
    ...
    def resource_class_name(self):
        """Gets the resource_class_name of this V1alpha1ResourceClaimSpec.  # noqa: E501
        ...
        :return: The resource_class_name of this V1alpha1ResourceClaimSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def resource_class_name(self, resource_class_name):
        """Sets the resource_class_name of this V1alpha1ResourceClaimSpec.

        ResourceClassName references the driver and additional parameters via the name of a ResourceClass that was created as part of the driver deployment.  # noqa: E501

        :param resource_class_name: The resource_class_name of this V1alpha1ResourceClaimSpec.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1ResourceClaimSpec):
            return False
