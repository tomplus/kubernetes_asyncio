...
class V1alpha1PodSchedulingSpec(object):
    ...
    def __init__(self, potential_nodes=None, selected_node=None, local_vars_configuration=None):  # noqa: E501
        """V1alpha1PodSchedulingSpec - a model defined in OpenAPI"""  # noqa: E501
    ...
    def potential_nodes(self):
        """Gets the potential_nodes of this V1alpha1PodSchedulingSpec.  # noqa: E501
        ...
        :return: The potential_nodes of this V1alpha1PodSchedulingSpec.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def potential_nodes(self, potential_nodes):
        """Sets the potential_nodes of this V1alpha1PodSchedulingSpec.

        PotentialNodes lists nodes where the Pod might be able to run.  The size of this field is limited to 128. This is large enough for many clusters. Larger clusters may need more attempts to find a node that suits all pending resources. This may get increased in the future, but not reduced.  # noqa: E501

        :param potential_nodes: The potential_nodes of this V1alpha1PodSchedulingSpec.  # noqa: E501
        :type potential_nodes: list[str]
        """
    ...
    def selected_node(self):
        """Gets the selected_node of this V1alpha1PodSchedulingSpec.  # noqa: E501
        ...
        :return: The selected_node of this V1alpha1PodSchedulingSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def selected_node(self, selected_node):
        """Sets the selected_node of this V1alpha1PodSchedulingSpec.

        SelectedNode is the node for which allocation of ResourceClaims that are referenced by the Pod and that use \"WaitForFirstConsumer\" allocation is to be attempted.  # noqa: E501

        :param selected_node: The selected_node of this V1alpha1PodSchedulingSpec.  # noqa: E501
        :type selected_node: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1PodSchedulingSpec):
            return False
