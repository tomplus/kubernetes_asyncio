...
class PolicyV1beta1RuntimeClassStrategyOptions(object):
    ...
    def __init__(self, allowed_runtime_class_names=None, default_runtime_class_name=None, local_vars_configuration=None):  # noqa: E501
        """PolicyV1beta1RuntimeClassStrategyOptions - a model defined in OpenAPI"""  # noqa: E501
    ...
    def allowed_runtime_class_names(self):
        """Gets the allowed_runtime_class_names of this PolicyV1beta1RuntimeClassStrategyOptions.  # noqa: E501
        ...
        :return: The allowed_runtime_class_names of this PolicyV1beta1RuntimeClassStrategyOptions.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def allowed_runtime_class_names(self, allowed_runtime_class_names):
        """Sets the allowed_runtime_class_names of this PolicyV1beta1RuntimeClassStrategyOptions.

        allowedRuntimeClassNames is a whitelist of RuntimeClass names that may be specified on a pod. A value of \"*\" means that any RuntimeClass name is allowed, and must be the only item in the list. An empty list requires the RuntimeClassName field to be unset.  # noqa: E501

        :param allowed_runtime_class_names: The allowed_runtime_class_names of this PolicyV1beta1RuntimeClassStrategyOptions.  # noqa: E501
        :type: list[str]
        """
    ...
    def default_runtime_class_name(self):
        """Gets the default_runtime_class_name of this PolicyV1beta1RuntimeClassStrategyOptions.  # noqa: E501
        ...
        :return: The default_runtime_class_name of this PolicyV1beta1RuntimeClassStrategyOptions.  # noqa: E501
        :rtype: str
        """
    ...
    def default_runtime_class_name(self, default_runtime_class_name):
        """Sets the default_runtime_class_name of this PolicyV1beta1RuntimeClassStrategyOptions.

        defaultRuntimeClassName is the default RuntimeClassName to set on the pod. The default MUST be allowed by the allowedRuntimeClassNames list. A value of nil does not mutate the Pod.  # noqa: E501

        :param default_runtime_class_name: The default_runtime_class_name of this PolicyV1beta1RuntimeClassStrategyOptions.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PolicyV1beta1RuntimeClassStrategyOptions):
            return False
