...
class V1beta1CertificateSigningRequestStatus(object):
    ...
    def __init__(self, certificate=None, conditions=None):  # noqa: E501
        """V1beta1CertificateSigningRequestStatus - a model defined in Swagger"""  # noqa: E501
    ...
    def certificate(self, certificate):
        ...
        :type: str
        """
        if certificate is not None and not re.search('^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$', certificate):  # noqa: E501
