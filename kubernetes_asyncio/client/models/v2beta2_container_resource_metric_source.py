...
class V2beta2ContainerResourceMetricSource(object):
    ...
    def __init__(self, container=None, name=None, target=None, local_vars_configuration=None):  # noqa: E501
        """V2beta2ContainerResourceMetricSource - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V2beta2ContainerResourceMetricSource):
            return False
