# kubernetes_asyncio.client.SchedulingV1alpha1Api
...
> V1alpha1PriorityClass create_priority_class(body, pretty=pretty)
...
api_instance = kubernetes_asyncio.client.SchedulingV1alpha1Api(kubernetes_asyncio.client.ApiClient(configuration))
body = kubernetes_asyncio.client.V1alpha1PriorityClass() # V1alpha1PriorityClass | 
...
# **list_priority_class**
> V1alpha1PriorityClassList list_priority_class(pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
> V1alpha1PriorityClass patch_priority_class(name, body, pretty=pretty)
...
> V1alpha1PriorityClass replace_priority_class(name, body, pretty=pretty)
