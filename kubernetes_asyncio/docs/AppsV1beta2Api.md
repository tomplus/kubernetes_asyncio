...
> V1beta2DaemonSetList list_namespaced_daemon_set(namespace, pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
> V1beta2DeploymentList list_namespaced_deployment(namespace, pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
> V1beta2ReplicaSetList list_namespaced_replica_set(namespace, pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
> V1beta2StatefulSetList list_namespaced_stateful_set(namespace, pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
> V1beta2ControllerRevision patch_namespaced_controller_revision(name, namespace, body, pretty=pretty)
...
> V1beta2DaemonSet patch_namespaced_daemon_set(name, namespace, body, pretty=pretty)
...
> V1beta2DaemonSet patch_namespaced_daemon_set_status(name, namespace, body, pretty=pretty)
...
> V1beta2Deployment patch_namespaced_deployment(name, namespace, body, pretty=pretty)
...
> V1beta2Scale patch_namespaced_deployment_scale(name, namespace, body, pretty=pretty)
...
> V1beta2Deployment patch_namespaced_deployment_status(name, namespace, body, pretty=pretty)
...
> V1beta2ReplicaSet patch_namespaced_replica_set(name, namespace, body, pretty=pretty)
...
> V1beta2Scale patch_namespaced_replica_set_scale(name, namespace, body, pretty=pretty)
...
> V1beta2ReplicaSet patch_namespaced_replica_set_status(name, namespace, body, pretty=pretty)
...
> V1beta2StatefulSet patch_namespaced_stateful_set(name, namespace, body, pretty=pretty)
...
> V1beta2Scale patch_namespaced_stateful_set_scale(name, namespace, body, pretty=pretty)
...
> V1beta2StatefulSet patch_namespaced_stateful_set_status(name, namespace, body, pretty=pretty)
...
> V1beta2ControllerRevision replace_namespaced_controller_revision(name, namespace, body, pretty=pretty)
...
> V1beta2DaemonSet replace_namespaced_daemon_set(name, namespace, body, pretty=pretty)
...
> V1beta2DaemonSet replace_namespaced_daemon_set_status(name, namespace, body, pretty=pretty)
...
> V1beta2Deployment replace_namespaced_deployment(name, namespace, body, pretty=pretty)
...
> V1beta2Scale replace_namespaced_deployment_scale(name, namespace, body, pretty=pretty)
...
> V1beta2Deployment replace_namespaced_deployment_status(name, namespace, body, pretty=pretty)
...
> V1beta2ReplicaSet replace_namespaced_replica_set(name, namespace, body, pretty=pretty)
...
> V1beta2Scale replace_namespaced_replica_set_scale(name, namespace, body, pretty=pretty)
...
> V1beta2ReplicaSet replace_namespaced_replica_set_status(name, namespace, body, pretty=pretty)
...
> V1beta2StatefulSet replace_namespaced_stateful_set(name, namespace, body, pretty=pretty)
...
> V1beta2Scale replace_namespaced_stateful_set_scale(name, namespace, body, pretty=pretty)
...
> V1beta2StatefulSet replace_namespaced_stateful_set_status(name, namespace, body, pretty=pretty)
