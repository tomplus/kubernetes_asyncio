# kubernetes_asyncio.client.AuthenticationV1alpha1Api
...
with kubernetes_asyncio.client.ApiClient(configuration) as api_client:
    ...
    api_instance = kubernetes_asyncio.client.AuthenticationV1alpha1Api(api_client)
    body = kubernetes_asyncio.client.V1alpha1SelfSubjectReview() # V1alpha1SelfSubjectReview | 
