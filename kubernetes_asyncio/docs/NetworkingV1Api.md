...
> V1NetworkPolicy create_namespaced_network_policy(namespace, body, include_uninitialized=include_uninitialized, pretty=pretty, dry_run=dry_run)
...
> V1NetworkPolicy patch_namespaced_network_policy(name, namespace, body, pretty=pretty, dry_run=dry_run)
...
> V1NetworkPolicy replace_namespaced_network_policy(name, namespace, body, pretty=pretty, dry_run=dry_run)
