...
> V1alpha1CSIStorageCapacity create_namespaced_csi_storage_capacity(namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
> V1alpha1CSIStorageCapacity patch_namespaced_csi_storage_capacity(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, force=force)
...
> V1alpha1CSIStorageCapacity replace_namespaced_csi_storage_capacity(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
