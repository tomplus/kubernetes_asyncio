...
> V1beta1EndpointSlice create_namespaced_endpoint_slice(namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
> V1beta1EndpointSlice patch_namespaced_endpoint_slice(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, force=force)
...
> V1beta1EndpointSlice read_namespaced_endpoint_slice(name, namespace, pretty=pretty)
...
> V1beta1EndpointSlice replace_namespaced_endpoint_slice(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
