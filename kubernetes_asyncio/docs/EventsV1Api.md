...
> EventsV1Event create_namespaced_event(namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
> EventsV1Event patch_namespaced_event(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force)
...
> EventsV1Event read_namespaced_event(name, namespace, pretty=pretty, exact=exact, export=export)
...
> EventsV1Event replace_namespaced_event(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
