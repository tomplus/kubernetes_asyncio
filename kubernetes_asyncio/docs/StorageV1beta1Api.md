...
# **create_csi_driver**
> V1beta1CSIDriver create_csi_driver(body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
api_instance = kubernetes_asyncio.client.StorageV1beta1Api(kubernetes_asyncio.client.ApiClient(configuration))
body = kubernetes_asyncio.client.V1beta1CSIDriver() # V1beta1CSIDriver | 
...
try:
    ...
    print("Exception when calling StorageV1beta1Api->create_csi_driver: %s\n" % e)
```
...
# **create_csi_node**
> V1beta1CSINode create_csi_node(body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
# create an instance of the API class
api_instance = kubernetes_asyncio.client.StorageV1beta1Api(kubernetes_asyncio.client.ApiClient(configuration))
body = kubernetes_asyncio.client.V1beta1CSINode() # V1beta1CSINode | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
dry_run = 'dry_run_example' # str | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
field_manager = 'field_manager_example' # str | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. (optional)
...
try:
    ...
    print("Exception when calling StorageV1beta1Api->create_csi_node: %s\n" % e)
```
...
> V1beta1StorageClass create_storage_class(body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
# create an instance of the API class
api_instance = kubernetes_asyncio.client.StorageV1beta1Api(kubernetes_asyncio.client.ApiClient(configuration))
body = kubernetes_asyncio.client.V1beta1StorageClass() # V1beta1StorageClass | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
dry_run = 'dry_run_example' # str | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
field_manager = 'field_manager_example' # str | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. (optional)
...
> V1beta1VolumeAttachment create_volume_attachment(body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
# create an instance of the API class
api_instance = kubernetes_asyncio.client.StorageV1beta1Api(kubernetes_asyncio.client.ApiClient(configuration))
body = kubernetes_asyncio.client.V1beta1VolumeAttachment() # V1beta1VolumeAttachment | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
dry_run = 'dry_run_example' # str | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
field_manager = 'field_manager_example' # str | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. (optional)
...
try:
    ...
    print("Exception when calling StorageV1beta1Api->create_volume_attachment: %s\n" % e)
```
...
> V1Status delete_collection_csi_driver(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try:
    api_response = api_instance.delete_collection_csi_driver(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling StorageV1beta1Api->delete_collection_csi_driver: %s\n" % e)
```
...
> V1Status delete_collection_csi_node(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try:
    api_response = api_instance.delete_collection_csi_node(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling StorageV1beta1Api->delete_collection_csi_node: %s\n" % e)
```
...
> V1Status delete_collection_storage_class(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try:
    api_response = api_instance.delete_collection_storage_class(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
...
> V1Status delete_collection_volume_attachment(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try:
    api_response = api_instance.delete_collection_volume_attachment(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling StorageV1beta1Api->delete_collection_volume_attachment: %s\n" % e)
```
...
# **delete_csi_driver**
> V1Status delete_csi_driver(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
...
try:
    ...
    print("Exception when calling StorageV1beta1Api->delete_csi_driver: %s\n" % e)
```
...
# **delete_csi_node**
> V1Status delete_csi_node(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
...
try:
    ...
    print("Exception when calling StorageV1beta1Api->delete_csi_node: %s\n" % e)
```
...
> V1Status delete_storage_class(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
...
> V1Status delete_volume_attachment(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
...
try:
    ...
    print("Exception when calling StorageV1beta1Api->delete_volume_attachment: %s\n" % e)
```
...
# **list_csi_driver**
> V1beta1CSIDriverList list_csi_driver(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try:
    api_response = api_instance.list_csi_driver(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling StorageV1beta1Api->list_csi_driver: %s\n" % e)
```
...
# **list_csi_node**
> V1beta1CSINodeList list_csi_node(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try:
    api_response = api_instance.list_csi_node(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling StorageV1beta1Api->list_csi_node: %s\n" % e)
```
...
# **list_storage_class**
> V1beta1StorageClassList list_storage_class(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try:
    api_response = api_instance.list_storage_class(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
...
> V1beta1VolumeAttachmentList list_volume_attachment(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try:
    api_response = api_instance.list_volume_attachment(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling StorageV1beta1Api->list_volume_attachment: %s\n" % e)
```
...
# **patch_csi_driver**
> V1beta1CSIDriver patch_csi_driver(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force)
...
try:
    ...
    print("Exception when calling StorageV1beta1Api->patch_csi_driver: %s\n" % e)
```
...
# **patch_csi_node**
> V1beta1CSINode patch_csi_node(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force)
...
try:
    ...
    print("Exception when calling StorageV1beta1Api->patch_csi_node: %s\n" % e)
```
...
# **patch_storage_class**
> V1beta1StorageClass patch_storage_class(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force)
...
> V1beta1VolumeAttachment patch_volume_attachment(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force)
...
try:
    ...
    print("Exception when calling StorageV1beta1Api->patch_volume_attachment: %s\n" % e)
```
...
# **read_csi_driver**
> V1beta1CSIDriver read_csi_driver(name, pretty=pretty, exact=exact, export=export)
...
try:
    ...
    print("Exception when calling StorageV1beta1Api->read_csi_driver: %s\n" % e)
```
...
# **read_csi_node**
> V1beta1CSINode read_csi_node(name, pretty=pretty, exact=exact, export=export)
...
try:
    ...
    print("Exception when calling StorageV1beta1Api->read_csi_node: %s\n" % e)
```
...
> V1beta1VolumeAttachment read_volume_attachment(name, pretty=pretty, exact=exact, export=export)
...
try:
    ...
    print("Exception when calling StorageV1beta1Api->read_volume_attachment: %s\n" % e)
```
...
# **replace_csi_driver**
> V1beta1CSIDriver replace_csi_driver(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
try:
    ...
    print("Exception when calling StorageV1beta1Api->replace_csi_driver: %s\n" % e)
```
...
# **replace_csi_node**
> V1beta1CSINode replace_csi_node(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
try:
    ...
    print("Exception when calling StorageV1beta1Api->replace_csi_node: %s\n" % e)
```
...
> V1beta1StorageClass replace_storage_class(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
> V1beta1VolumeAttachment replace_volume_attachment(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
try:
    ...
    print("Exception when calling StorageV1beta1Api->replace_volume_attachment: %s\n" % e)
```
