...
> V1beta1CSIStorageCapacity create_namespaced_csi_storage_capacity(namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
body = kubernetes_asyncio.client.V1beta1CSIStorageCapacity() # V1beta1CSIStorageCapacity | 
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
dry_run = 'dry_run_example' # str | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)
field_manager = 'field_manager_example' # str | fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. (optional)
 ...
 **body** | [**V1beta1CSIStorageCapacity**](V1beta1CSIStorageCapacity.md)|  | 
 **pretty** | **str**| If &#39;true&#39;, then the output is pretty printed. | [optional] 
 **dry_run** | **str**| When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed | [optional] 
 **field_manager** | **str**| fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint. | [optional] 
...
[**V1beta1CSIStorageCapacity**](V1beta1CSIStorageCapacity.md)
...
# **delete_csi_driver**
> V1beta1CSIDriver delete_csi_driver(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
...
# **delete_csi_node**
> V1beta1CSINode delete_csi_node(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
...
> V1beta1StorageClass delete_storage_class(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
...
> V1beta1VolumeAttachment delete_volume_attachment(name, pretty=pretty, dry_run=dry_run, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy, body=body)
...
# **list_csi_driver**
> V1beta1CSIDriverList list_csi_driver(pretty=pretty, allow_watch_bookmarks=allow_watch_bookmarks, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, resource_version_match=resource_version_match, timeout_seconds=timeout_seconds, watch=watch)
...
[**V1beta1CSIStorageCapacityList**](V1beta1CSIStorageCapacityList.md)
...
> V1beta1CSIStorageCapacityList list_namespaced_csi_storage_capacity(namespace, pretty=pretty, allow_watch_bookmarks=allow_watch_bookmarks, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, resource_version_match=resource_version_match, timeout_seconds=timeout_seconds, watch=watch)
...
# **list_storage_class**
> V1beta1StorageClassList list_storage_class(pretty=pretty, allow_watch_bookmarks=allow_watch_bookmarks, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, resource_version_match=resource_version_match, timeout_seconds=timeout_seconds, watch=watch)
...
> V1beta1VolumeAttachmentList list_volume_attachment(pretty=pretty, allow_watch_bookmarks=allow_watch_bookmarks, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, resource_version_match=resource_version_match, timeout_seconds=timeout_seconds, watch=watch)
...
> V1beta1CSIStorageCapacity patch_namespaced_csi_storage_capacity(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force)
...
# **read_csi_driver**
> V1beta1CSIDriver read_csi_driver(name, pretty=pretty)
...
# **read_csi_node**
> V1beta1CSINode read_csi_node(name, pretty=pretty)
...
> V1beta1CSIStorageCapacity read_namespaced_csi_storage_capacity(name, namespace, pretty=pretty)
...
# **read_storage_class**
> V1beta1StorageClass read_storage_class(name, pretty=pretty)
...
> V1beta1VolumeAttachment read_volume_attachment(name, pretty=pretty)
...
> V1beta1CSIStorageCapacity replace_namespaced_csi_storage_capacity(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
