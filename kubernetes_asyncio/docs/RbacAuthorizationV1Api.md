...
# **create_cluster_role**
> V1ClusterRole create_cluster_role(body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
> V1ClusterRoleBinding create_cluster_role_binding(body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
> V1Role create_namespaced_role(namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
> V1RoleBinding create_namespaced_role_binding(namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
# **list_cluster_role**
> V1ClusterRoleList list_cluster_role(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
> V1ClusterRoleBindingList list_cluster_role_binding(pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
> V1RoleList list_namespaced_role(namespace, pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
> V1RoleBindingList list_namespaced_role_binding(namespace, pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
> V1RoleBindingList list_role_binding_for_all_namespaces(_continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, pretty=pretty, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
> V1RoleList list_role_for_all_namespaces(_continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, pretty=pretty, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
# **patch_cluster_role**
> V1ClusterRole patch_cluster_role(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force)
...
> V1ClusterRoleBinding patch_cluster_role_binding(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force)
...
> V1Role patch_namespaced_role(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force)
...
> V1RoleBinding patch_namespaced_role_binding(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force)
...
> V1ClusterRole replace_cluster_role(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
> V1ClusterRoleBinding replace_cluster_role_binding(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
> V1Role replace_namespaced_role(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
> V1RoleBinding replace_namespaced_role_binding(name, namespace, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
