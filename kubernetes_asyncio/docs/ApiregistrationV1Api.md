...
# **create_api_service**
> V1APIService create_api_service(v1_api_service, include_uninitialized=include_uninitialized, pretty=pretty, dry_run=dry_run)
...
api_instance = kubernetes_asyncio.client.ApiregistrationV1Api(kubernetes_asyncio.client.ApiClient(configuration))
v1_api_service = kubernetes_asyncio.client.V1APIService() # V1APIService | 
include_uninitialized = True # bool | If true, partially initialized resources are included in the response. (optional)
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
dry_run = 'dry_run_example' # str | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional)

try:
    api_response = api_instance.create_api_service(v1_api_service, include_uninitialized=include_uninitialized, pretty=pretty, dry_run=dry_run)
    pprint(api_response)
...
> V1Status delete_collection_api_service(include_uninitialized=include_uninitialized, pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try:
    api_response = api_instance.delete_collection_api_service(include_uninitialized=include_uninitialized, pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
...
# **list_api_service**
> V1APIServiceList list_api_service(include_uninitialized=include_uninitialized, pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try:
    api_response = api_instance.list_api_service(include_uninitialized=include_uninitialized, pretty=pretty, _continue=_continue, field_selector=field_selector, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
...
# **patch_api_service**
> V1APIService patch_api_service(name, unknown_base_type, pretty=pretty, dry_run=dry_run)
...
> V1APIService patch_api_service_status(name, unknown_base_type, pretty=pretty, dry_run=dry_run)
...
# **replace_api_service**
> V1APIService replace_api_service(name, v1_api_service, pretty=pretty, dry_run=dry_run)
...
try:
    api_response = api_instance.replace_api_service(name, v1_api_service, pretty=pretty, dry_run=dry_run)
    pprint(api_response)
except ApiException as e:
...
> V1APIService replace_api_service_status(name, v1_api_service, pretty=pretty, dry_run=dry_run)
...
try:
    api_response = api_instance.replace_api_service_status(name, v1_api_service, pretty=pretty, dry_run=dry_run)
    pprint(api_response)
except ApiException as e:
