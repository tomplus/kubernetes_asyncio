...
> V1beta1CertificateSigningRequest patch_certificate_signing_request_approval(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force)
...
force = True # bool | Force is going to \"force\" Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests. (optional)
    ...
    try:
        ...
        print("Exception when calling CertificatesV1beta1Api->patch_certificate_signing_request_approval: %s\n" % e)
```
...
> V1beta1CertificateSigningRequest read_certificate_signing_request(name, pretty=pretty)
...
> V1beta1CertificateSigningRequest read_certificate_signing_request_approval(name, pretty=pretty)
...
pretty = 'pretty_example' # str | If 'true', then the output is pretty printed. (optional)
    ...
    try:
        ...
        print("Exception when calling CertificatesV1beta1Api->read_certificate_signing_request_approval: %s\n" % e)
```
...
> V1beta1CertificateSigningRequest replace_certificate_signing_request_approval(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
