...
> V1ControllerRevision create_namespaced_controller_revision(namespace, body, pretty=pretty)
...
> V1DaemonSet create_namespaced_daemon_set(namespace, body, pretty=pretty)
...
> V1Deployment create_namespaced_deployment(namespace, body, pretty=pretty)
...
> V1ReplicaSet create_namespaced_replica_set(namespace, body, pretty=pretty)
...
> V1StatefulSet create_namespaced_stateful_set(namespace, body, pretty=pretty)
...
> V1ControllerRevisionList list_namespaced_controller_revision(namespace, pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
> V1DaemonSetList list_namespaced_daemon_set(namespace, pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
> V1DeploymentList list_namespaced_deployment(namespace, pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
> V1ReplicaSetList list_namespaced_replica_set(namespace, pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
> V1StatefulSetList list_namespaced_stateful_set(namespace, pretty=pretty, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
> V1ControllerRevision patch_namespaced_controller_revision(name, namespace, body, pretty=pretty)
...
> V1DaemonSet patch_namespaced_daemon_set(name, namespace, body, pretty=pretty)
...
> V1DaemonSet patch_namespaced_daemon_set_status(name, namespace, body, pretty=pretty)
...
> V1Deployment patch_namespaced_deployment(name, namespace, body, pretty=pretty)
...
> V1Scale patch_namespaced_deployment_scale(name, namespace, body, pretty=pretty)
...
> V1Deployment patch_namespaced_deployment_status(name, namespace, body, pretty=pretty)
...
> V1ReplicaSet patch_namespaced_replica_set(name, namespace, body, pretty=pretty)
...
> V1Scale patch_namespaced_replica_set_scale(name, namespace, body, pretty=pretty)
...
> V1ReplicaSet patch_namespaced_replica_set_status(name, namespace, body, pretty=pretty)
...
> V1StatefulSet patch_namespaced_stateful_set(name, namespace, body, pretty=pretty)
...
> V1Scale patch_namespaced_stateful_set_scale(name, namespace, body, pretty=pretty)
...
> V1StatefulSet patch_namespaced_stateful_set_status(name, namespace, body, pretty=pretty)
...
> V1ControllerRevision replace_namespaced_controller_revision(name, namespace, body, pretty=pretty)
...
> V1DaemonSet replace_namespaced_daemon_set(name, namespace, body, pretty=pretty)
...
> V1DaemonSet replace_namespaced_daemon_set_status(name, namespace, body, pretty=pretty)
...
> V1Deployment replace_namespaced_deployment(name, namespace, body, pretty=pretty)
...
> V1Scale replace_namespaced_deployment_scale(name, namespace, body, pretty=pretty)
...
> V1Deployment replace_namespaced_deployment_status(name, namespace, body, pretty=pretty)
...
> V1ReplicaSet replace_namespaced_replica_set(name, namespace, body, pretty=pretty)
...
> V1Scale replace_namespaced_replica_set_scale(name, namespace, body, pretty=pretty)
...
> V1ReplicaSet replace_namespaced_replica_set_status(name, namespace, body, pretty=pretty)
...
> V1StatefulSet replace_namespaced_stateful_set(name, namespace, body, pretty=pretty)
...
> V1Scale replace_namespaced_stateful_set_scale(name, namespace, body, pretty=pretty)
...
> V1StatefulSet replace_namespaced_stateful_set_status(name, namespace, body, pretty=pretty)
