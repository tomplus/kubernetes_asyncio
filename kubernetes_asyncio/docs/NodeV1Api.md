...
> V1RuntimeClass create_runtime_class(body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
...
# **patch_runtime_class**
> V1RuntimeClass patch_runtime_class(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, force=force)
...
# **read_runtime_class**
> V1RuntimeClass read_runtime_class(name, pretty=pretty, exact=exact, export=export)
...
> V1RuntimeClass replace_runtime_class(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager)
