...
> V2alpha1CronJob create_namespaced_cron_job(namespace, body, include_uninitialized=include_uninitialized, pretty=pretty, dry_run=dry_run)
...
> V2alpha1CronJob patch_namespaced_cron_job(name, namespace, body, pretty=pretty, dry_run=dry_run)
...
> V2alpha1CronJob patch_namespaced_cron_job_status(name, namespace, body, pretty=pretty, dry_run=dry_run)
...
> V2alpha1CronJob replace_namespaced_cron_job(name, namespace, body, pretty=pretty, dry_run=dry_run)
...
> V2alpha1CronJob replace_namespaced_cron_job_status(name, namespace, body, pretty=pretty, dry_run=dry_run)
