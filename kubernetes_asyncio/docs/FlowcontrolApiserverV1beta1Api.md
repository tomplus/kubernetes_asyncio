...
# **create_flow_schema**
> V1beta1FlowSchema create_flow_schema(body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
> V1beta1PriorityLevelConfiguration create_priority_level_configuration(body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
# **patch_flow_schema**
> V1beta1FlowSchema patch_flow_schema(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, force=force)
...
> V1beta1FlowSchema patch_flow_schema_status(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, force=force)
...
> V1beta1PriorityLevelConfiguration patch_priority_level_configuration(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, force=force)
...
> V1beta1PriorityLevelConfiguration patch_priority_level_configuration_status(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation, force=force)
...
# **replace_flow_schema**
> V1beta1FlowSchema replace_flow_schema(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
> V1beta1FlowSchema replace_flow_schema_status(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
> V1beta1PriorityLevelConfiguration replace_priority_level_configuration(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
...
> V1beta1PriorityLevelConfiguration replace_priority_level_configuration_status(name, body, pretty=pretty, dry_run=dry_run, field_manager=field_manager, field_validation=field_validation)
