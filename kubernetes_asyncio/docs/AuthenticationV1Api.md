...
# **create_token_review**
> V1TokenReview create_token_review(v1_token_review, dry_run=dry_run, include_uninitialized=include_uninitialized, pretty=pretty)
...
v1_token_review = kubernetes_asyncio.client.V1TokenReview() # V1TokenReview | 
...
try:
    api_response = api_instance.create_token_review(v1_token_review, dry_run=dry_run, include_uninitialized=include_uninitialized, pretty=pretty)
    pprint(api_response)
